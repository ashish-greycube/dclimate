...
def update_heater_info_based_on_installation_note(self,method):
  if method=='on_submit':
    if self.heater_serial_no_cf and len(self.items)==1:
      ...
      for serial_no in serial_nos:      
        update_heater_info_in_serial_no(serial_no,self.name,self.heater_serial_no_cf,self.end_customer_cf,self.end_customer_name_cf)
...
def update_heater_info_in_serial_no(serial_no,installation_note_name,heater_serial_no_cf,end_customer_cf,end_customer_name_cf):
  ...
  if serial_no.heater_serial_no_cf or serial_no.installation__note_cf:
      ...
      serial_no.end_customer_cf=end_customer_cf
