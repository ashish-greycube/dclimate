...
def execute(filters=None):
	...
	if filters.get('group_by')=='End Customer':
		filters.group_by='end_customer_cf'
	...
	column_map = frappe._dict(
		{
			...
			"end_customer_cf": {
				...
				"fieldname": "end_customer_cf",
				"fieldtype": "Link",
				"options": "Customer",
				"width": 140,
			},	
			"end_customer_name_cf": {
				"label": _("End Customer Name"),
				"fieldname": "end_customer_name_cf",
				"fieldtype": "Data",
				"width": 140,
			},					
			"customer_group": {
	...
	return frappe._dict(
		{
			...
			"customer": "customer",
			"end_customer_cf":"end_customer_cf",
			"end_customer_name_cf":"end_customer_name_cf",
	...
	def load_invoice_items(self):
		...
		self.si_list = frappe.db.sql(
			...
			select
				...
				`tabSales Invoice`.end_customer_cf,`tabSales Invoice`.end_customer_name_cf,
		...
		return frappe._dict(
			{
				...
				"end_customer_cf":row.end_customer_cf,
				"end_customer_name_cf":row.end_customer_name_cf,
		...
		return frappe._dict(
			{
				...
				"end_customer_cf":product_bundle.end_customer_cf,
				"end_customer_name_cf":product_bundle.end_customer_name_cf,
